...
Vue.component('chrono', __webpack_require__(35));
...
new Vue({
    ...
    methods: {
        edit: function edit(lots) {
            this.lots = lots;
            this.showModalEdit = true;
        },
        updateLot: function updateLot() {
            var _this = this;

            axios.put('/lots/update', this.lots).then(function (response) {
                _this.showModalEdit = false;
                location.reload();
            });
        },
        stopChrono: function stopChrono(time, lot_id) {
            this.time = time.h * 3600 + time.mn * 60 + time.s;
            this.lot_id = lot_id;
            this.showObservation = true;
        },
        pauseChrono: function pauseChrono(time, lot_id) {
...
window.iziToast = __webpack_require__(13);
...
Component.options.__file = "/Users/Barry/Laravel/reporting/resources/assets/js/components/Chrono.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] Chrono.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-8c71520e", Component.options)
  } else {
    hotAPI.reload("data-v-8c71520e", Component.options)
  }
...
var update = __webpack_require__(39)("25ea3a75", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-8c71520e\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Chrono.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-8c71520e\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Chrono.vue");
...
// module
exports.push([module.i, "\n.disabled[data-v-8c71520e] {\n\topacity: 0.4;\n\tpointer-events: none;\n}\n.fa-play[data-v-8c71520e] {\n\tcolor: #00d1b2;\n\tcursor: pointer;\n}\n.fa-pause[data-v-8c71520e] {\n\tcolor: #ffdd57;\n\tcursor: pointer;\n}\n.fa-stop[data-v-8c71520e] {\n\tcolor: #ff3860;\n\tcursor: pointer;\n}\n", ""]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('p', [_vm._v(_vm._s(_vm.time.h) + "h : " + _vm._s(_vm.time.mn) + "mn : " + _vm._s(_vm.time.s) + "s : " + _vm._s(_vm.time.ms) + "ms")]), _vm._v(" "), _c('span', {
    staticClass: "icon is-small"
  }, [_c('i', {
    class: {
      'fa fa-play': true, 'disabled': _vm.state == 'start'
    },
    on: {
    ...
    class: {
      'fa fa-pause': true, 'disabled': _vm.state == 'pause'
    },
    on: {
      "click": function($event) {
        $event.preventDefault();
    ...
    class: {
      'fa fa-stop': true, 'disabled': _vm.state == 'stop'
    },
    on: {
      "click": function($event) {
        $event.preventDefault();
    ...
    class: {
      'fa fa-undo': true, 'disabled': _vm.state == 'reset'
    },
    on: {
      "click": function($event) {
        $event.preventDefault();
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-8c71520e", module.exports)
  }
}
